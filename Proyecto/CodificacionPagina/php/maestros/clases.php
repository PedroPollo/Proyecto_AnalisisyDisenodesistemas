      ...
      ?>
        <div class="col-lg-3">
          ...
          <div class="card-body">
              ...
              Aula:<a class="btn btn-primary disabled" tabindex="-1" role="button" aria-disabled="true"><?php echo $row[3] ?></a></p>
              <div class="btn-group" role="group" aria-label="Basic example">
                <a href="alumnos.php?clase=<?php echo $row[0]; ?>" type="button" class="btn btn-success">Alumnos</a>
