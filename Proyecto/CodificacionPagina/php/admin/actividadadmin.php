    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="actividadadmin.php">Administrar Actividad</a>
          </li>
          <li class="nav-item">
      ...
      <header id="page-header" class="row">
        ...
        <table id="tablaActividad" class="table text-center" style="width: 100%">
        <div class="col-12 pt-3 pb-3">
    <div class="card ">
        <div class="card-body ">
            <div class="d-sm-flex align-items-center">
                <div class="mr-auto">
                    <div class="page-context-header"><div class="page-header-headings"><h1>Administrar Acvtividades</h1></div></div>
                </div>
          ...
          <button id="btnNuevo" type="button" class="btn btn-primary" data-toggle="modal">Agregar Actividad</button>
        </div>
