$(document).ready(function() {
    ...
    tablaGrados = $('#tablaGrados').DataTable({  
        "ajax":{            
            "url": "crudgrados.php", 
...
$('#formGrados').submit(function(e){                         
    ...
    grado = $.trim($('#grado').val());                     
        $.ajax({
          ...
          type: "POST",
          datatype:"json",    
          data:  {user_id:user_id, grado:grado ,opcion:opcion},    
    ...
    $("#btnNuevo").click(function(){
        ...
        $(".modal-title").text("Alta de Grados");
    ...
    $(document).on("click", ".btnBorrar", function(){
        ...
        if (respuesta) {            
            $.ajax({
              ...
              success: function() {
                  tablaGrados.row(fila.parents('tr')).remove().draw();                  
               }
            });	
        }
     });
